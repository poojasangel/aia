...
(lib.road_center = function() {
	this.initialize(img.road_center);
}).prototype = p = new cjs.Bitmap();
...
(lib.middle = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.instance = new lib.road_center();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.middle, new cjs.Rectangle(-2,-1,1017,504), null);
...
// stage content:
(lib.race3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.progress_mc.setTransform(496.1,624.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/journey_progress_base.png?1526989920316", id:"journey_progress_base"},
		{src:"images/journey_progress_fill.png?1526989920316", id:"journey_progress_fill"},
		{src:"images/road_center.png?1526989920316", id:"road_center"}
	],
	preloads: []
};
