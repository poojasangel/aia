...
(lib.Road04 = function() {
	this.initialize(img.Road04);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1014,503);// helper functions:
...
(lib.middle = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.instance = new lib.Road04();
	this.instance.parent = this;
	this.instance.setTransform(24,200.1,0.001,0.002);

	this.instance_1 = new lib.Road04();
	this.instance_1.parent = this;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.middle, new cjs.Rectangle(0,0,1014,503), null);
...
(lib.road_mid = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(1010,-66.4,1,1,0,0,0,507,185.1);

	this.instance_1 = new lib.middle();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-2,-66.4,1,1,0,0,0,507,185.1);

	this.instance_2 = new lib.middle();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-1014,-66.4,1,1,0,0,0,507,185.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.road_mid, new cjs.Rectangle(-1521,-251.5,3038,503), null);
...
(lib.road_anim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:1011.2},119).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2531.6,-251.5,3038,503);
...
(lib.race1 = function(mode,startPosition,loop) {
	...
	this.background.setTransform(509.8,333);
	...
	this.shape.setTransform(507,325,1.212,1.087);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.progress_mc}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1521.5,325,5071,650);
// library properties:
lib.properties = {
	width: 1014,
	height: 650,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/journey_progress_base.png?1528102617704", id:"journey_progress_base"},
		{src:"images/journey_progress_fill.png?1528102617704", id:"journey_progress_fill"},
		{src:"images/Road04.jpg?1528102617704", id:"Road04"}
	],
	preloads: []
};
