...
mainModel.controller('race4Controller', function ($scope, $interval,
        $rootScope) {
        ...
        var animation = $interval(function () {
            ...
            if (cont == numImgs) {
                ...
                if ($scope.levels[$scope.currentLevel - 1]['life_rem'] != 0) {
                    ...
                    oComponent.foreground.play();
					$scope.playAudio('plane');
                }
                else
                {
